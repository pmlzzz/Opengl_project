...
int Time_loc = -1;
int Pass_loc = -1;
static float ka[4] = { 0.1, 0.2, 0.1, 1.0 };
static float kd[4] = { 0.5, 0.7, 0.5, 1.0 };
static float ks[4] = { 0.6, 0.6, 0.6, 1.0 };
...
void draw_gui()
{
   ...
   ImGui::ColorEdit4("ambient_color",ka);
   ImGui::ColorEdit4("diffuse_color", kd);
   ImGui::ColorEdit4("spec_color", ks);
   int ka_loc = glGetUniformLocation(program, "ambient_color");
   int kd_loc = glGetUniformLocation(program, "diffuse_color");
   int ks_loc = glGetUniformLocation(program, "spec_color");
   glUniform4fv(ka_loc, 1, ka);
   glUniform4fv(kd_loc, 1, kd);
   glUniform4fv(ks_loc, 1, ks);
   static bool wireframe = false;
   ImGui::SliderFloat("m", &m, 0.001f, 10.0f);
   ImGui::SliderFloat("Eta", &Eta, 0.001f, 3.0f);
   int m_loc = glGetUniformLocation(program, "m");
   glUniform1f(m_loc, m);
   int Eta_loc = glGetUniformLocation(program, "Eta");
   glUniform1f(Eta_loc, Eta);
   ...
   ImGui::RadioButton("all", &option2, 0); ImGui::SameLine();
   ImGui::RadioButton("F", &option2, 1); ImGui::SameLine();
   ImGui::RadioButton("D", &option2, 2); ImGui::SameLine();
   ImGui::RadioButton("G", &option2, 3);
   int option2_loc = glGetUniformLocation(program, "option2");
   glUniform1i(option2_loc, option2);
   ImGui::Render();
 }
